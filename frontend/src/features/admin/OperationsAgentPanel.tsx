...
function OperationsReportView({
  ...
  return (
    <div className="operations-report">
      <Card className="operations-summary-card" padding="large">
        <div>
          <div className="detail-section-heading">
            ...
            <GeminiLabel>
              {isGeminiModel(report.model_used) ? "Generated by Gemini" : "AI operations report"}
            </GeminiLabel>
          </div>
      ...
      <div className="operations-snapshot-grid" aria-label="Operations report snapshot">
        <CivicStatCard
          description="Active records included in this analysis."
          eyebrow="Issues Analyzed"
          icon="🧭"
          value={report.total_issues_analyzed}
        />
        <CivicStatCard
          description="Immediate admin attention candidates."
          eyebrow="Urgent Issues"
          icon="⚠"
          tone={report.urgent_issues.length ? "danger" : "success"}
          value={report.urgent_issues.length}
        />
        <CivicStatCard
          description="Possible duplicate groups for admin review."
          eyebrow="Duplicate Clusters"
          icon="⧉"
          tone={report.duplicate_clusters.length ? "warning" : "neutral"}
          value={report.duplicate_clusters.length}
        />
      </div>
